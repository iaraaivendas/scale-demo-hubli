  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // I.ARA Custom Variants
        iara: 
          "bg-gradient-to-r from-iara-400 to-iara-500 text-primary-foreground shadow-md hover:shadow-glow hover:from-iara-300 hover:to-iara-400 transition-all duration-300",
        "iara-outline":
          "border-2 border-primary bg-transparent text-primary hover:bg-primary/10 hover:shadow-glow-sm",
        "iara-ghost":
          "text-primary hover:bg-primary/10 hover:text-primary",
        "iara-dark":
          "bg-card border border-border text-foreground hover:border-primary/50 hover:bg-accent",
        success:
